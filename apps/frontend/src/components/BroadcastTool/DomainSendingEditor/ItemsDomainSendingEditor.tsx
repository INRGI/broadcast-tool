...
import MultiSelectFromList from "../../Common/MultiSelectFromList/MultiSelectFromList";
...
const ItemsDomainSendingEditor: React.FC<DomainSendingEditorProps> = ({
  items,
  onChange,
  title,
  parentCompanies,
...
export default ItemsDomainSendingEditor;
